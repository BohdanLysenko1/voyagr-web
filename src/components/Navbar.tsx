          ...
          <div ref={navRef} className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center space-x-1">
              ...
              <div className="relative" ref={notificationRef}>
                ...
                {/* Notification Modal */}
                {isNotificationModalOpen && (
                  <div className="absolute right-0 top-full mt-3 w-96 bg-white/95 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl p-4 z-50">
                    ...
                    <div className="mt-4 pt-3 border-t border-gray-200/50">
                      <button className="w-full py-2 text-primary font-semibold text-sm hover:bg-primary/5 rounded-lg transition-colors">
